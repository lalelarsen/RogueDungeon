...
public class WallTileLevelOne extends BaseObject {
    ...
    public WallTileLevelOne(Walls w) {
        ...
        //SW addHitbox(36, 88, new Point(0, 44), false);
        ...
        //SE_SW addHitbox(64, 88, new Point(0,44), false);
        //SW_NW addHitbox(36, 128, new Point(0, 0), false);
        
        
        //N addHitbox(16, 32, new Point(24, 0), false);
        //E addHitbox(16, 40, new Point(48, 44), false);
        //W addHitbox(16, 40, new Point(0, 44), false);
        //S addHitbox(16, 60, new Point(24, 68), false);
        
        //N_S addHitbox(16, 128, new Point(24, 0), false);
        //E_W addHitbox(64, 40, new Point(0, 44), false);
        //Pillar addHitbox(32, 52, new Point(16, 32), false);
        ...
        switch (w) {
            ...
            case P:
                ...
                addHitbox(32, 52, new Point(16, 32), false);
                break;
            case N:
                img = SpriteController.loadSingleSpriteDungeon(32 * 4, 160 * 4, 16 * 4, 32 * 4);
                addHitbox(16, 32, new Point(24, 0), false);
                addHitbox(32, 52, new Point(16, 32), false);
                break;
            case S:
            ...
            case E:
                ...
                addHitbox(16, 40, new Point(48, 44), false);
                addHitbox(32, 52, new Point(16, 32), false);
                break;
            case W:
                img = SpriteController.loadSingleSpriteDungeon(48 * 4, 160 * 4, 16 * 4, 32 * 4);
                addHitbox(16, 40, new Point(0, 44), false);
                addHitbox(32, 52, new Point(16, 32), false);
                break;
            case E_S:
            ...
            case E_W:
                ...
                addHitbox(64, 40, new Point(0, 44), false);
                addHitbox(32, 52, new Point(16, 32), false);
                break;
            case N_E:
            ...
            case E_SE_S:
                ...
                addHitbox(36, 88, new Point(28, 44), false);
                addHitbox(32, 52, new Point(16, 32), false);
                break;
            case N_NE_E:
            ...
            case S_SW_W:
                ...
                addHitbox(36, 88, new Point(0, 44), false);
                addHitbox(32, 52, new Point(16, 32), false);
                break;
            case N_W_NW:
            ...
            case E_SE_S_SW_W:
                ...
                addHitbox(64, 88, new Point(0, 44), false);
                //BOT
                break;
            case N_S_SW_W_NW:
